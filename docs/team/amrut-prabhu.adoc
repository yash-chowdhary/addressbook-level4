...
It provides all members of the club with they ability to browse through profiles of other members, participate in polls,
and manage club-related tasks.

*Club Connect* is an application that is targeted at those who prefer using the keyboard over a mouse.
So, it uses a Command Line Interface (CLI) for input.
