...
* *Minor enhancement*: Improved navigability of member list by adding compress/decompress mechanism and revamping `Find` command
...
include::../UserGuide.adoc[tag=polls]
