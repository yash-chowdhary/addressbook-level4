...
More projects will be added as I develop more applications.
...
** What it does: Allows `Exco` members to add/delete polls and view/hide results of polls. Members can vote in polls.
