...
_Figure 57. ResultDisplay before modification_
+
**After**
+
Figure 58 below shows the `ResultDisplay` after the modification.
+
image::getting-started-ui-result-after.png[width="200"]
_Figure 58. ResultDisplay after modification_
+
****
* Hints
...
+
Figure 59 below shows the `StatusBarFooter` before the modification.
+
**Before**
+
image::getting-started-ui-status-before.png[width="500"]
_Figure 59. StatusBarFooter before modification_
+
Figure 60 below shows the `StatusBarFooter` after the modification.
+
**After**
+
image::getting-started-ui-status-after.png[width="500"]
_Figure 60. StatusBarFooter after modification_
+
****
* Hints
