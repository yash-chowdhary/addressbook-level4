...
** Cons: Requires dealing with commands that have already been undone: We must remember to skip these commands. Furthermore, the Single Responsibility Principle and Separation of Concerns are violated as `HistoryManager` now needs to do two * different things.
// end::undoredo[]
