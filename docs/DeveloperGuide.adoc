...
2.  ClubConnect shows a list of persons containing keyword in specified field.
+
Use case ends.
...
Use case resumes at step 1.
* 1b. No field specified.
** 1b2. ClubConnect shows a list of persons containing keyword in any possible field.
+
Use case ends.
