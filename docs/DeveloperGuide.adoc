...
This event is handled by the `Storage` component.
It makes use of the `CsvClubBookStorage` and `CsvUtil` classes to write data to the file specified by the export path.
