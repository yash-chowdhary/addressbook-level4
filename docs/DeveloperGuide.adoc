...
Figure 7 shows finer details concerning `XYZCommand` and `Command` depicted in Figure 6.
...
.Initial state of `undoStack` and `redoStack`
...
.State of `undoStack` and `redoStack` after executing `add` command
...
.State of `undoStack` and `redoStack` after executing `undo` command.
...
.State of `undoStack` and `redoStack` after executing `clear` command.
...
.State of `undoStack` and `redoStack` after executing `list` command.
