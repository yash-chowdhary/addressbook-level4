...
image::AssignTaskCommandUML.png[width="450"]
...
image::ChangeAssigneeCommandUML.png[width="450"]
...
image::SDforChangeAssigneeCommandParser.png[width="800"]
_Figure 33. Sequence Diagram of `ChangeAssigneeCommandParser`._

`Model#changeAssignee` is invoked during the execution of the command. Here is the implementation:
...
This further calls `ClubBook#updateTaskAssignee`.
...
image::SDforChangeAssignee.png[width="800"]
...
image::ChangeTaskStatusCommandUML.png[width="450"]
