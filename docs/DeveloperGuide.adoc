...
Figure 23 depicts the sequence of parsing the command.

image::SDforChangeProfilePhotoCommandParser.png[width="650"]
_Figure 23. Sequence Diagram for Change Profile Photo Command parsing_
