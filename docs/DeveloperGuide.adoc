...
|`* * *` |Member |find a member by name |locate details of persons without having to go through the entire list
...
|`*` |Member with many persons in the address book |sort members by name |locate a member easily
