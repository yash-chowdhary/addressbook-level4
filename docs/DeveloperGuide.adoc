...
_Figure 42. Sequence Diagram for adding a poll_
...
_Figure 43. Sequence Diagram for deleting a poll_
...
_Figure 44. Sequence Diagram for voting in a poll_
...
This is illustrated in the UML diagram shown in Figure 52.

image::ImportCommandUML.png[width="150"]
_Figure 52. ImportCommand UML Diagram_

The `import` command involves the use of multiple components of the Club Connect application.
Figure 53 (below) shows the high-level _Sequence Diagram_ for the `import` command.

image::SDforImport.png[width="900"]
_Figure 53. High Level Sequence Diagram for the `import C:/Users/Admin/club.csv` command_
...
Figure 52 depicts the UML diagram for the `ExportCommand` class.

image::ExportCommandUML.png[width="350"]
_Figure 52. ExportCommand UML Diagram_

The `export` command uses multiple components of the Club Connect application.
The _Sequence Diagram_ below (Figure 53) shows the interactions between some of these components.
As you can see, the `ExportCommand` is driven by the `NewExportDataAvailableEvent`.

image::SDforExport.png[width="800"]
_Figure 53. High Level Sequence Diagram for the `export C:/Users/Admin/members.csv` command_

This event is handled by the `Storage` component as shown in Figure 54.

image::SDforExportEventHandling.png[width="650"]
_Figure 54. High Level Sequence Diagram showing how the `Storage` component handles the `NewExportDataAvailableEvent`
...
Figure 53 (below) shows the interactions between these components.
...
_Figure 53. High Level Sequence Diagram for the `changepic C:/Users/Admin/Desktop/photo.png` command_
...
The actual displaying of the profile photo is done by using this xml code:
...
Figure 61 below describes the encryption procedure used in AES – specifically, the Cipher Block Chaining (CBC) mode.

image::encryption.png[width="500" align="center"]
_Figure 61. AES – CBC mode encryption._

Figure 62 below shows the decryption process.

image::decryption.png[width="500" align="center"]
_Figure 62. AES – CBC mode decrption._
...
.  Set the destination to `Save as PDF`, then click `Save` to save a copy of the file in PDF format. For best results, use the settings in Figure 63 below.

image::chrome_save_as_pdf.png[width="300"]
_Figure 63. Screenshot of saving documentation as PDF in Chrome_
...
+
Figure 64 below shows the member details before the modification.
+
**Before**
+
image::getting-started-ui-tag-before.png[width="300"]

_Figure 64. Member details before modification_
+
Figure 65 below shows the member details after the modification.
+
**After**
+
image::getting-started-ui-tag-after.png[width="300"]

_Figure 65. Member details after modification_
+
****
* Hints
...
Figure 66 below shows the `ResultDisplay` before the modification. +
**Before**
+
image::getting-started-ui-result-before.png[width="200"]
_Figure 66. ResultDisplay before modification_
+
**After**
+
Figure 67 below shows the `ResultDisplay` after the modification.
+
image::getting-started-ui-result-after.png[width="200"]
_Figure 67. ResultDisplay after modification_
+
****
* Hints
...
Figure 68 below shows the `StatusBarFooter` before the modification.
+
**Before**
+
image::getting-started-ui-status-before.png[width="500"]

_Figure 68. StatusBarFooter before modification_
+
Figure 69 below shows the `StatusBarFooter` after the modification.
+
**After**
+
image::getting-started-ui-status-after.png[width="500"]

_Figure 69. StatusBarFooter after modification_
+
****
* Hints
