...
* `add n/Betsy Crowe t/head e/betsycrowe@example.com m/A2345678K`
...
* The group must exist in the addressbok.
...
e.g. `add n/James Jerome p/22224444 e/jamesjerome@example.com m/A1234567H`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
