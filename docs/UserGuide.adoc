...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL m/MATRIC_NUMBER pic/PHOTO_PATH [g/GROUP] [t/TAG]...`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [m/MATRIC_NUMBER] [pic/PHOTO_PATH] [g/GROUP] [t/TAG]...`
