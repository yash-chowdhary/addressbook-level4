...
* *Select UI* +
In order to get the intended UI, ensure the following conditions are met.

** Names of selected member cannot be more than 36 characters.
** Tags of selected member cannot be more than 7.
// end::csv-data-format[]
