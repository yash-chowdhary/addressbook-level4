...
{empty}[https://github.com/yash-chowdhary[github]] [<<johndoe#, portfolio>>]
...
{empty}[https://github.com/amrut-prabhu[github]] [<<johndoe#, portfolio>>]

Role: Developer +
Responsibilities: In charge of Logic, Documentation

'''

=== Muhammad Nur Kamal Bin Mohammed Ariff
image::muhdnurkamal.png[width="150", align="left"]
{empty}[https://github.com/MuhdNurKamal[github]] [<<johndoe#, portfolio>>]
...
{empty}[https://github.com/th14thmusician[github]] [<<johndoe#, portfolio>>]
