...
* EXCOntact is a desktop application. It has a <<DeveloperGuide#gui,GUI>> but most of the user interactions happen using a <<DeveloperGuide#cli,CLI>>.
...
* EXCOntact is the solution to this problem as it helps <<DeveloperGuide#club,clubs>> manage and organize their activities and members efficiently and effectively.
* EXCOntact has the following features:
