...
public class XmlSerializableClubBookTest {
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        XmlSerializableClubBook dataFromFile = XmlUtil.getDataFromFile(TYPICAL_PERSONS_FILE,
                XmlSerializableClubBook.class);
        ClubBook clubBookFromFile = dataFromFile.toModelType();
        ClubBook typicalPersonsClubBook = TypicalPersons.getTypicalClubBook();
        assertEquals(clubBookFromFile, typicalPersonsClubBook);
    }

    @Test
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        XmlSerializableClubBook dataFromFile = XmlUtil.getDataFromFile(INVALID_PERSON_FILE,
                XmlSerializableClubBook.class);
