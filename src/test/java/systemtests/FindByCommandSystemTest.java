...
public class FindByCommandSystemTest extends ClubBookSystemTest {
    ...
    public void find() {
         ...
         * -> 2 members found
         */
        String command = "   " + FindByCommand.COMMAND_WORD + " " + KEYWORD_MATCHING_MEIER + "   ";
         ...
         * -> 2 members found
         */
        command = FindByCommand.COMMAND_WORD + " Daniel Benson NonMatchingKeyWord";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        command = FindByCommand.COMMAND_WORD + " MeIeR";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find member in club book, keyword is substring of name -> 2 members found */
        command = FindByCommand.COMMAND_WORD + " Mei";
        ModelHelper.setFilteredList(expectedModel, BENSON, DANIEL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find member in club book, name is substring of keyword -> 0 members found */
        command = FindByCommand.COMMAND_WORD + " Meiers";
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find member not in club book -> 0 members found */
        command = FindByCommand.COMMAND_WORD + " " + PREFIX_NAME + " Mark";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find phone number of member in club book -> 1 members found */
        command = FindByCommand.COMMAND_WORD + " " + PREFIX_PHONE + " " + DANIEL.getPhone().value;
        ModelHelper.setFilteredList(expectedModel, DANIEL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find matric number of member in club book -> 1 members found */
        command = FindByCommand.COMMAND_WORD + " " + PREFIX_MATRIC_NUMBER + " " + DANIEL.getMatricNumber().value;
        ModelHelper.setFilteredList(expectedModel, DANIEL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find email of member in club book -> 1 members found */
        command = FindByCommand.COMMAND_WORD + " " + PREFIX_EMAIL + " " + BENSON.getEmail().value;
        ...
        command = FindByCommand.COMMAND_WORD + " " + tags.get(0).tagName;
        ModelHelper.setFilteredList(expectedModel, BENSON);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        command = FindByCommand.COMMAND_WORD + " Daniel";
        ModelHelper.setFilteredList(expectedModel, DANIEL);
        assertCommandSuccess(command, expectedModel);
